...
function BossService:SpawnBoss(bossId)
	...
	if assetId and assetId ~= "rbxassetid://0" and assetId ~= "" then
		...
		if bossId == "GlitchKing" then
			-- The Glitch King: Large, imposing, dark/purple
			rootPart.Size = Vector3.new(15, 30, 15)
			...
			crown.Name = "Crown"
			crown.Size = Vector3.new(18, 6, 18)
			crown.Color = Color3.fromRGB(255, 0, 0)
			...
			for i = 1, 4 do
				...
				segment.Size = Vector3.new(6, 12, 6)
		...
		elseif bossId == "GlitchOverlord" then
			-- Glitch Overlord: Red/Black, slightly smaller than King but still big
			rootPart.Size = Vector3.new(12, 25, 12)
			rootPart.Position = Constants.ZONES["Glitch Wastes"].Center + Vector3.new(20, 12.5, 20) -- Offset slightly
			rootPart.Color = Color3.fromRGB(10, 0, 0)
			...
			for i = 1, 8 do
				...
				sWeld.Part0 = rootPart
				sWeld.Part1 = spike
				sWeld.C0 = CFrame.new(offset) * CFrame.Angles(math.rad(45), angle, 0)
				sWeld.Parent = spike
			end
		else
			-- Generic Placeholder
